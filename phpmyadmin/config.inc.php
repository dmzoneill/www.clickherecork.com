<?php
/* $Id: config.inc.php,v 1.80.2.3 2002/07/10 14:16:20 rabus Exp $ */
 ...
 */
$cfgPmaAbsoluteUri = 'http://www.clickherecork.com/phpmyadmin/';
...
$cfgServers[$i]['controluser']   = 'dave';          // MySQL control user settings
                                                // (this user must have read-only
$cfgServers[$i]['controlpass']   = 'megadude';          // access to the "mysql/user"
                                                // and "mysql/db" tables)
$cfgServers[$i]['auth_type']     = 'config';    // Authentication method (config, http or cookie based)?
$cfgServers[$i]['user']          = 'dave';      // MySQL user
$cfgServers[$i]['password']      = 'megadude';          // MySQL password (only needed
