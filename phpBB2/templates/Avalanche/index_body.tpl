...
<table width="100%" cellspacing="0" border="0" cellpadding="0">
	<tr>
		...
		<td class="middle_bottom" align="center"><span class="gensmall" nowrap="nowrap">{S_TIMEZONE}</span></td>
...
<table width="100%" cellpadding="2" cellspacing="0" border="0" class="forumline">
	...
	<!-- BEGIN forumrow -->
	<tr>
		<td class="row1" align="center" valign="middle" height="50" width="50"><img src="{catrow.forumrow.FORUM_FOLDER_IMG}" width="46" height="30" alt="{catrow.forumrow.L_FORUM_FOLDER_ALT}" title="{catrow.forumrow.L_FORUM_FOLDER_ALT}" /></td>
