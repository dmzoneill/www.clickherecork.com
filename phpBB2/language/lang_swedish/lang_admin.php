 ...
 *
 *     $Id: lang_admin.php,v 1.1.2.1 2002/05/19 17:32:51 psotfx Exp $
 *
 ****************************************************************************/
...
$lang['Backup'] = "Backup";
$lang['Restore_explain'] = "Detta kommer att utföra en fullständig återställning av alla phpBB tabeller från en sparad fil. Om din server stödjer det kan du ladda upp en gzip komprimerad text fil vilken kommer att dekomprimeras. <b>VARNING</b>Detta kommer att skriva över all existerande data. Återställningen kan ta en lång tid att utföra men lämna inte denna sida förrän den är färdig.";
$lang['Backup_explain'] = "Här kan du ta backup på alla dina phpBB relaterade data. Om du har andra egna tabeller i samma databas som phpBB som du också vill säkerhetskopiera så ange deras namn separerad med komman i \"Övriga tabeller\"-rutan nedanför Om din server stöjder det kan du också gzip komprimera filen för att minska storleken innan du laddar ner den.";
...
$lang['Group_auth_explain'] = "Här kan du ändra rättigheter och moderatorstatus för varje grupp. Glöm inte att fastän du ändrar grupprättigheten att användarens egna rättigheter fortfarande kan ge dom access till forum, m.m. Du kommer att få en varning i så fall.";
...
$lang['Allowed_Access'] = "Tillåt tillträde";
...
$lang['Conflict_access_userauth'] = "Denna användare har fortfarande tillgång till detta forum via gruppmedlemskap. Du kanske vill ändra grupprättigheterna eller ta bort denna användare från gruppen för att förhindra att de har tillträde. Gruppens rättigheter (och berörda forum) listas nedan.";
$lang['Conflict_mod_userauth'] = "Användaren har fortfarande moderatorrättigheter till forumet via gruppmedlemskap. Du kan antingen ändra grupprättigheterna eller ta bort denna användare från gruppen för att förhindra att de har moderatorrättigheter. Gruppens rättigheter (och berörda forum) listas nedan.";

$lang['Conflict_access_groupauth'] = "Följande användare har fortfarande åtkomsträttigheter till detta forum via deras användarrättigheter. Du kanske vill ändra användarrättigheterna för att förhindra dem från att ha åtkomst till forumet. Användarens rättigheter (och berörda forum) listas nedan.";
$lang['Conflict_mod_groupauth'] = "Följande användare har fortfarande moderatorrättigheter till forumet via användarrättigheter. Du kanske vill ändra användarrättigheterna för att förhindra dem från att ha åtkomst till forumet. Användarens rättigheter (och berörda forum) listas nedan.";
...
$lang['Ban_username_explain'] = 'Du kan banna flera användare på en gång genom att använda den rätta kombinationen mellan mus och tangentbord';

$lang['Ban_IP'] = "Bannlys en eller flera IP adresser eller värdnamn";
$lang['IP_hostname'] = "IP adresser eller värdnamn";
$lang['Ban_IP_explain'] = "För att specifiera flera olika IP adresser eller värdnamn, skilj dem åt med kommatecken. För att specifiera en rad olika IP adresser separera början och slutet med ett bindesstreck(-), för att specifiera ett wildcard (vad som helst) använd *";

$lang['Ban_email'] = "Bannlys en eller flera epost adresser";
$lang['Ban_email_explain'] = "För att specificera mer än en e-post adress, skilj dem åt med kommatecken. För att specifiera ett wildcard (vad som helst) namn använd *, till exempel *@hotmail.com";
...
$lang['Unban_email_explain'] = "Du kan ta bort flera bannlysningar av e-post adresser samtidigt genom att använda den ändamålsenliga kombinationen av mus och tangenbord för din dator och webläsare.";
...
$lang['Config_explain'] = "Formuläret här ger dig möjlighet att ändra alla allmänna foruminställningar. För användar och forumkonfiguration så änvänd de relaterade länkarna på vänster sida.";
...
$lang['Use_SMTP_explain'] = "Säg ja om du vill eller måste skicka e-post via en angiven server istället för via den lokala e-post funktionen";
...
$lang['Cookie_secure_explain'] = "Om servern körs via SSL aktivera det här, annars låt det vara inaktiverat";
...
$lang['Forum_admin_explain'] = "Från denna panel kan du lägga till, radera, ändra, sortera och synkronisera katagorier och forum";
...
$lang['Forum_edit_delete_explain'] = "Forumläret under låter dig skräddarsy alla allmänna foruminställningar. Använd relaterad länkar på vänster sida för användar och forum konfiguraration";
...
$lang['prune_days'] = "Ta bort ämnen som inte har svarats på efter";
$lang['Set_prune_data'] = "Du har aktiverat autoreducering för detta forum men har inte satt en frekvens eller antal dagar för reducering. Gå tillbaka och sätt detta";
...
$lang['Click_return_forumadmin'] = "Klicka %shär%s för att återgå till Forum Administrationen";
...
$lang['smile_desc'] = "På denna sida kan du lägga till, radera och redigera emoticons eller smileys som dina användare kan använda i inlägg och personliga meddelanden.";
...
$lang['Click_return_smileadmin'] = "Klicka %shär%s för att återgå Smiley Administrationen";
...
$lang['Click_return_useradmin'] = "Klicka %shär%s för att återgå till användaradministrationen";
...
$lang['Click_return_massemail'] = "Klicka %shär%s för att återgå till mass e-post formuläret";
...
$lang['No_update_ranks'] = 'Titeln raderades. Hursomhelst, användar konton som använder denna titel blev inte uppdaterade.  Du måste manuellt återställa titeln på dessa konton.';
...
$lang['Click_return_styleadmin'] = "Klicka %sHär%s för att återgå till Stiladministrationen";
