...
$faq[] = array("Hvad er BBkoder?", "BBKoder er en speciel udgave af HTML. Om du kan benytte BBkode i dine indlæg, er noget administratoren afgør. Ud over at det kan angives med virkning for hele forummet, kan det også angives ud for hver indlæg. Dette kan sættes når indlægget skrives. BBkoden i sig selv er bygget op ligesom HTML - der findes en startkode og en slutkode, disse er omgivet af hak parenteser [ og ] i stedet for &lt; og &gt;. De give en stor kontrol over hvad og hvordan indholdet præsenteres. Afhængig af den template der bruges vil du opdage at det er meget nemt og intuitivt at bruge BBkoder, dette sker gennem den <i>peg og klik</i>-brugerflade som findes over beskedfeltet når du skriver et nyt indlæg. Selv om der er lavet med denne nemme brugerflade kan du stadig få brug for denne lille vejledning.");
