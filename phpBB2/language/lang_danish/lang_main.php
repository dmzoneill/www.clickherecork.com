...
$lang['Record_online_users'] = "Flest brugere online på samme tid var <b>%s</b>, %s"; // first %s = number of users, second %s is the date.

$lang['Admin_online_color'] = "%sAdministrator%s";
$lang['Mod_online_color'] = "%sRedaktør%s";

$lang['You_last_visit'] = "Du besøgte sidst siden %s"; // %s replaced by date/time
...
$lang['Search_user_posts'] = "Søg efter denne brugers indlæg";
...
$lang['Signature_explain'] = "Denne tekst kan blive tilføjet som underskrift til alle de indlæg som du skriver, der er en begrænsning på %d karakterer";
...
$lang['Too_many_registers'] = 'Du har forsøgt at registrere for mange gange. Prøv igen senere, tak.';
...
$lang['Avatar_imagesize'] = "Billedfilen må ikke være større end (%d,%d) (hxb) pixels";
...
$lang['Reg_agreement'] = "Administratorer og redaktører af dette forum vil prøve at fjerne eller rette i indlæg der kan være stødende så hurtigt som muligt, dog vil det være umuligt at gennemlæse alle indlæg. Derfor accepterer du at være indforstået med, at alle indlæg i dette forum udtrykker holdninger og meninger af forfatterne af indlæggene, og ikke administratorer, redaktører eller webmastere (bortset fra indlæg skrevet af disse) og derfor kan disse heller ikke holdes ansvarlige.<br /><br />Du vedkender også ikke at skrive indlæg der indeholder skældsord, pornografiske , vulgære, bagtalene, hadefulde, truende, seksuelt-orienterede eller andre ord/vendinger som strider mod gældende lovgivning. Såfremt dette konstateres, kan det føre til at du øjeblikkeligt og permanent udelukkes fra forummet (din Internet udbyder vil blive orienteret). Din unikke IP adresse logges i alle indlæg der skrives til dette forum, for at forebygge misbrug af enhver slags. Du vedkender også at administrator, redaktører og webmastere tilhørende dette forum har ret til at fjerne, rette eller lukke ethvert emne/indlæg hvornår som helst de måtte finde det nødvendigt. Som bruger giver du ret til at alle informationer som du har indtastet gemmes i en database. Disse informationer vil ikke blive videregivet til 3. part uden din viden; webmastere, administratorer eller redaktører kan ikke blive holdt ansvarlige for eventuelle hackerangreb der måtte føre til afsløring af disse data.<br /><br />Dette forum bruger cookies til at gemme information på din lokale harddisk. Disse cookies indeholder ingen af de informationer som du har indtastet om dig selv, de er kun til for at sørge for at du får den nemmeste brugerflade. Din email bliver kun brugt til at sende en verificering af dine tilmeldingsdetaljer og kodeord (og til at sende et nyt kodeord, hvis du skulle glemme dit nuværende).<br /><br />Ved at klikke på nedenstående tilmeldingslink accepterer du at være indforstået med disse forhold.";
...
$lang['Email_message_desc'] = "Denne besked vil blive sendt som ren tekst, skrive derfor ikke HTML eller BBCode. returadressen på denne mail vil blive sat til din email addresse.";
...
$lang['characters_posts'] = "karakterer af indlægget";
