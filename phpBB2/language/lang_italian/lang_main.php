 ...
 *
 *     $Id: lang_main.php,v 1.7.2.2 2002/11/13 23:24:12 psotfx Exp $
 *
 ****************************************************************************/
...
$lang['Rules_post_can'] = '<b>Puoi</b> inserire nuovi Topic in questo forum';
$lang['Rules_post_cannot'] = '<b>Non puoi</b> inserire nuovi Topic in questo forum';
$lang['Rules_reply_can'] = '<b>Puoi</b> rispondere ai Topic in questo forum';
$lang['Rules_reply_cannot'] = '<b>Non puoi</b> rispondere ai Topic in questo forum';
...
$lang['No_topics_post_one'] = 'Non ci sono Topic in questo forum<br />Clicca su <b>Inserisci un Nuovo Topci</b> per inserirne uno';
...
$lang['HTML_is_ON'] = 'HTML è <u>ATTIVO</u>';
$lang['HTML_is_OFF'] = 'HTML è <u>DISATTIVATO</u>';
$lang['BBCode_is_ON'] = '%sBBCode%s è <u>ATTIVO</u>'; // %s are replaced with URI pointing to FAQ
...
$lang['Date_format_explain'] = 'La sintassi usata è identica alla funzione PHP <a href=\"http://www.php.net/manual/it/html/function.date.html\" target=\"_other\">data()</a>';
